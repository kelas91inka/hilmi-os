...
const SOCIALS = [
  { href: 'https://github.com/hilmimuafa', icon: GithubIcon, label: 'GitHub' },
  { href: 'https://linkedin.com/in/hilmimuafa', icon: LinkedinIcon, label: 'LinkedIn' },
  { href: 'https://twitter.com/hilmimuafa', icon: TwitterIcon, label: 'X / Twitter' },
  { href: 'mailto:hilmi@muhlim.my.id', icon: Mail, label: 'Email' },
];

export function PublicFooter({ lang }: { lang: Language }) {
