...
export function PortalSidebar() {
  ...
  return (
    <aside
      className={cn(
        'relative flex h-full flex-col border-r bg-sidebar transition-all duration-300 ease-in-out overflow-hidden',
    ...
    >
      ...
      <button
        ...
        className={cn(
          'absolute top-[72px] -right-3 z-10 flex h-6 w-6 items-center justify-center rounded-full border border-border bg-sidebar text-muted-foreground shadow-md transition-all hover:text-foreground hover:border-primary/30 hover:shadow-primary/10 focus-visible:ring-2 focus-visible:ring-primary',
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      expanded ? 'flex-row px-3 py-2.5' : 'flex-col py-2.5 px-0 items-center justify-center',
                      isActive
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        expanded ? 'text-[13px]' : 'text-[9px] mt-0.5',
                        expanded ? '' : 'max-w-full truncate text-center'
                      )}
                    >
                      {item.name}
                    </span>
      ...
      <div className={cn('border-t border-sidebar-border p-2 shrink-0 space-y-1.5', expanded ? '' : 'flex flex-col items-center')}>
        {/* Sync pulse */}
        <div className={cn(
          ...
          {expanded && <span className="font-mono-num">Tersinkron</span>}
        </div>
        <LogoutButton />
      </div>
    </aside>
